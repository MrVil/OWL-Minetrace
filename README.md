...
Nous avons insérer cette règle grâce à l'interface d'Hylar :
```SPARQL
...
```
Ayant des difficultés à comprendre cet outil, nous n'avons malheureusement pas pu vérifier son bon marchement.
